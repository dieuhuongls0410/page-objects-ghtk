...
public class Create_Package_02_AbstractPage_01 {
	WebDriver driver;
...
// login abstractPage
		abstractPage.sendkeyToElement(driver, "//input[@id='ShopEmail']", "huongntd111@ghtk.vn");
		abstractPage.sendkeyToElement(driver, "//input[@id='ShopPassword']", "123456");
		abstractPage.clickToElement(driver, "//span[contains(text(),'Đăng Nhập')]");
	}
